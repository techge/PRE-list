...
def main(delimiter):
    ...
    with open('README.md', 'w') as f:
        ...
        f.write("This is a collection of " + str(len(papers)) + " scientific papers about " + \
                ...
                "Furthermore, there is a very extensive surveys which focuses on the methods " + \
                "and approaches of PRE tools that are based on network traces. The work of " + \
                "Kleber et al. is an excellent starting point to see what was already tried " + \
                "and for which use cases a method is working best.\n\n" + \
